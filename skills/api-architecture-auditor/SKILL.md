...
description: |-
  ...
  - Config/secrets source: env vars, config file, secrets manager, or hardcoded in source/deploy files.
  ...
  ## Step 5: Transport & network checks
